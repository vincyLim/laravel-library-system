    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('book.update', $book->id)}}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <x-form-text-input label="Title" name="title" value="{{ $book->title }}"/>
                <x-form-select label="Category" name="category[]" selectClass="formMultiSelect">
                ...
                <x-form-text-area label="Description" name="description">{{ $book->description }}</x-form-text-area>
